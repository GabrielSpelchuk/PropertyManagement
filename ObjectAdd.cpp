...
#pragma resource "*.dfm"
TObjectAddForm *ObjectAddForm;
//---------------------------------------------------------------------------
__fastcall TObjectAddForm::TObjectAddForm(TComponent* Owner)
	: TForm(Owner)
{
    Memo1->Text = "";
...
//---------------------------------------------------------------------------
void __fastcall TObjectAddForm::Button1Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TObjectAddForm::Button2Click(TObject *Sender)
{
	DM->ADOTObjects->Last();
